...
public class IntSet_07_04 {
	...
	// 생성자
	public IntSet_07_04(int capacity) {
		num = 0;
		max = capacity;
		try {
	...
	// 집합 s에 복사합니다.
	public void copyTo(IntSet_07_04 s) {
	...
	// 집합 s를 복사합니다.
	public void copyFrom(IntSet_07_04 s) {
	...
	// 집합 s와 같은지 확인합니다.
	public boolean equalTo(IntSet_07_04 s) {
	...
	public void unionOf(IntSet_07_04 s1, IntSet_07_04 s2) {
	...
	// ------------------------------ 연습7-4 ------------------------------//
	// 집합 s1과 s2의 교집합을 복사
	public void intersectionOf(IntSet_07_04 s1, IntSet_07_04 s2) {
		clear();
	...
	// 집합 s1과 s2의 차집합을 복사
	public void differenceOf(IntSet_07_04 s1, IntSet_07_04 s2) {
		clear();
		for (int i = 0; i < s1.num; i++)
			if (!s2.contains(s1.set[i]))
				add(s1.set[i]);

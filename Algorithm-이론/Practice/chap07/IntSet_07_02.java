...
public class IntSet_07_02 {
	...
	// 집합 s에 복사합니다.
	public void copyTo(IntSet_07_02 s) {
	...
	// 집합 s를 복사합니다.
	public void copyFrom(IntSet_07_02 s) {
	...
	// 집합 s와 같은지 확인합니다.
	public boolean equalTo(IntSet_07_02 s) {
	...
	public void unionOf(IntSet_07_02 s1, IntSet_07_02 s2) {
	...
	// ------------------------------ 연습 7-2 ------------------------------//
	// 집합 s와 합집합
	public boolean add(IntSet_07_02 s) {
		boolean flag = false;
		for (int i = 0; i < num; i++)
			if (add(set[i]) == true)
				flag = true;
	...
	// 집합 s와 교집합
	public boolean retain(IntSet_07_02 s) {
		boolean flag = false;
		for (int i = 0; i < num; i++)
	...
	// 집합 s와 차집합
	public boolean remove(IntSet_07_02 s) {
		boolean flag = false;
		for (int i = 0; i < num; i++)
